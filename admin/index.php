    ...
    <div class="wrapper">
     ...
     <?php $page = isset($_GET['page']) ? $_GET['page'] : 'home';  ?>
      ...
      <div class="content-wrapper bg-dark pt-3" style="min-height: 567.854px;">
        ...
        <!-- Es el comando que contiene TODOS los elementos de la pagína del administrador ej. dashboard, Lista de usuarios, etc. 
      Y manda al documento "404.html en caso de error. Se utiliza para cargar dinámicamente el contenido de la 
      página web basado en la variable $page -->
