    ...
    <div class="row" id="appointment">
        <div class="col-6" id="frm-field">
            ...
            <input type="hidden" name="patient_id" value="<?php echo isset($patient_id) ? $patient_id : '' ?>">
                ...
                <div class="form-group">
                    <label for="gender" class="control-label">tipo de incidente</label>
                    <select type="text" class="custom-select" name="gender" required>
                    <option <?php echo isset($incident['severity']) && $incident['severity'] == "Baja" ? "selected": "" ?>>No Especificado</option>
                        <option <?php echo isset($incident['severity']) && $incident['severity'] == "Media" ? "selected": "" ?>>Ransomware</option>
                        <option <?php echo isset($incident['severity']) && $incident['severity'] == "Alta" ? "selected": "" ?>>Filtración de datos</option>
                        <option <?php echo isset($incident['severity']) && $incident['severity'] == "Crítica" ? "selected": "" ?>>Ataque de Denegación de Servicio (DDoS)</option>
                        <option <?php echo isset($incident['severity']) && $incident['severity'] == "Grave" ? "selected": "" ?>>Intrusión de red</option>
                        <option <?php echo isset($incident['severity']) && $incident['severity'] == "Moderada" ? "selected": "" ?>>Vulnerabilidad de aplicación web</option>
                        <option <?php echo isset($incident['severity']) && $incident['severity'] == "No especificado" ? "selected": "" ?>>No especificado</option>
                    </select>
                </div>
        ...
        <div class="col-6">
                ...
                <div class="form-group">
                    <label for="address" class="control-label">Descripción</label>
            ...
            <?php endif; ?>
            <div class="form-group">
                <label for="date_sched" class="control-label">Fecha de incidencia</label>
            ...
            <?php if($_settings->userdata('id') > 0): ?>
            <div class="form-group">
                <label for="status" class="control-label">Prioridad</label>
                <select name="status" id="status" class="custom custom-select">
                    <option value="0"<?php echo isset($status) && $status == "0" ? "selected": "" ?>>Baja</option>
                    <option value="1"<?php echo isset($status) && $status == "1" ? "selected": "" ?>>Media</option>
                    <option value="2"<?php echo isset($status) && $status == "2" ? "selected": "" ?>>Alta</option>
                </select>
            </div>
            <?php else: ?>
        ...
        <div class="form-group d-flex justify-content-end w-100 form-group">
            <button class="btn-primary btn">Enviar incidencia</button>
