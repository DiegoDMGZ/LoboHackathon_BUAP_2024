...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> Nueva incidencia</a>
		</div>
	</div>
	<div class="card-body">
				...
				<div class="w-100 d-flex">
					...
					<div class="col-3">
						<select id="w_selected" class="custom-select select" >
							<option value="Baja">Marcar como baja prioridad</option>
							<option value="Media">Marcar como media prioridad</option>
							<option value="Alta">Marcar como alta prioridad</option>
...
<script>
	...
	$(document).ready(function(){
		...
		$('#create_new').click(function(){
			uni_modal("Formulario de asistencia | Feria de empleo 2023","appointments/manage_appointment.php",'mid-large')
		})
		$('.edit_data').click(function(){
			uni_modal("Editar detalles","appointments/manage_appointment.php?id="+$(this).attr('data-id'),'mid-large')
		})
